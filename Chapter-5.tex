...
In this part, a thorough analysis is presented for the proposed learning-based reconstruction attack in scenarios with different levels of access to the XOR shares. Two cases are considered: (i) training of the decoder using all four XOR shares and testing in full and partial input scenarios (Figs.~\ref{fig:all_results}(a)-(d)), and (ii) training of the decoder using only three consecutive XOR shares (Figs.~\ref{fig:all_results}(e)-(f)).
