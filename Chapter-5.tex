...
When only one of the four XOR shares is available (three shares missing), reconstruction quality remains poor. The visual output for the digit ``7'' is shown in Fig.~\ref{fig:all_results}(d).
...
the available shares contain equivalent amounts of partial information about
the secret and use the same dataset prior knowledge for decoding. The low
SSIM scores are consistent with the information-theoretic security
bounds of the XOR protocol and prior work on neural network decoding with
missing inputs.
