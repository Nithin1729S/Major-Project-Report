...
\label{sec:ch2-prelim}
% ------------------------------------------------------------
This section introduces the foundational concepts and theoretical background required to understand the cryptanalysis presented in this chapter. It covers chaos-based image encryption schemes, the permutation-diffusion architecture, and the chosen-plaintext attack model used to break the target scheme.
